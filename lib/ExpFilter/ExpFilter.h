...
// 
// Source: https://github.com/Megunolink/MLP
// 
...
public:
  ExpFilter(void)
    : m_WeightNew(10), m_Current(0)
  { }

  ExpFilter(T WeightNew, T Initial)
...
public:
  ExpFilter(void)
    : m_fWeightNew(0.1), m_fCurrent(0)
  { }

  ExpFilter(float fWeightNew, float fInitial)
